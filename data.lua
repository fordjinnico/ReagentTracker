RT_REAGENTS = {
    ...
    DragonIsles = {
        Mining = {
            ...
            {189143, 188658, 190311}, -- Draconium Oore
            {190312, 190313, 190314}, -- Khazgorite Ore
        },
        Herbalism = {
    ...
    TheWarWithin = {
        Mining = {
            ...
            {238201, 238212, 238213}, -- Desolate Talus
            217707,                   -- Imperfect Null Stone
            210939,                   -- Null Stone
            240216,                   -- Kareshi Resonating Stone
        },
        Herbalism = {
            {210796, 210797, 210798}, -- Mycobloom
            {210805, 210806, 210807}, -- Blessing Blossom
            {210808, 210809, 210810}, -- Arathors Spear
            {210799, 210800, 210801}, -- Luredrop
            {210802, 210803, 210804}, -- Orbinid
            { 239690, 239691, 239692 }, -- Phantom Bloom
            213197,                     -- Null Lotus
            240194, -- Kareshi Lotus
        }
    },
    Midnight = {
        Mining = {
